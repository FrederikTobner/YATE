...
/**
 * @file syntax.h
 * @brief File containing the declaration of the syntax highlighting
 * functionality.
 */
...
/// @brief Gets the amount of languages for which syntax highlighting is
/// provided
...
/// @param highlightGroup The highlight group where the corresponding color
/// value is determined
/// @return A 32 bit value where the 3 least significant bytes control the
/// displayed color and the most significant bit is used to detetemnine whether
/// the highlighting applies to the fore- or the background.
