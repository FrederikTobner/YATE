...
char *CKeywords[] = {"switch",   "if",      "while",  "for",    "break",
                     "continue", "return",  "else",   "struct", "union",
                     "typedef",  "static",  "enum",   "case",   "int|",
...
char *CelloxKeywords[] = {"if",   "else",   "for",  "while", "return", "and",
                          "or",   "null",   "this", "super", "false",  "true",
                          "fun|", "class|", "var|", NULL};
...
char *GoKeywords[] = {
    ...
    // Go types
    "nil|", "true|", "false|", "error|", "err|", "int|", "int32|", "int64|",
    "uint|", "uint32|", "uint64|", "string|", "bool|", NULL};

char *JBASICFileExtensions[] = {".bas", NULL};

char *JBASICKeywords[] = {
    // JBASIC keywords
    "LET", "DIM", "CLS", "INPUT", "PRINT", "NOT", "MOD", "IF", "THEN", "ELSE",
    "END", "FOR", "TO", "NEXT", "WHILE", "REPEAT", "UNTIL", "DO", "SWITCH",
    "CASE", "GOTO", "SUB", "CALL", "let", "dim", "cls", "input", "print", "not",
    "mod", "if", "then", "else", "end", "for", "to", "next", "while", "repeat",
    "until", "do", "switch", "case", "goto", "sub", "call",
    // JBASIC built in functions
    "ABS|", "ACS|", "ASH|", "ASN|", "ATH|", "ATN|", "AVG|", "COS|", "EXP|",
    "LOG|", "MAX|", "MIN|", "SIN|", "SQR|", "SUM|", "TAN|", "LIST|", "RND|",
    "VAL|", "LEN|", NULL};
...
editor_syntax_t HighLightDataBase[] = {
    {"C", CFileExtensions, CKeywords, "//", "/*", "*/",
     SYNTAX_HIGHLIGHT_NUMBERS | SYNTAX_HIGHLIGHT_STRINGS},
    {"C++", CPPFileExtensions, CPPKeywords, "//", "/*", "*/",
     SYNTAX_HIGHLIGHT_NUMBERS | SYNTAX_HIGHLIGHT_STRINGS},
    {"Cellox", CelloxFileExtensions, CelloxKeywords, "//", "/*", "*/",
     SYNTAX_HIGHLIGHT_NUMBERS | SYNTAX_HIGHLIGHT_STRINGS},
    {"Go", GoFileExtensions, GoKeywords, "#", "", "",
     SYNTAX_HIGHLIGHT_NUMBERS | SYNTAX_HIGHLIGHT_STRINGS},
    {"JBASIC", JBASICFileExtensions, JBASICKeywords, "REM", "", "",
     SYNTAX_HIGHLIGHT_NUMBERS | SYNTAX_HIGHLIGHT_STRINGS},
    {"Lua", LuaFileExtensions, LuaKeywords, "--", "--[[", "--]]",
     SYNTAX_HIGHLIGHT_NUMBERS | SYNTAX_HIGHLIGHT_STRINGS},
    {"Python", PythonFileExtensions, PythonKeywords, "//", "", "",
     SYNTAX_HIGHLIGHT_NUMBERS | SYNTAX_HIGHLIGHT_STRINGS},
};
