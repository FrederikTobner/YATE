...
/**
 * @file syntax.c
 * @brief File containing the implementation of the syntax highlighting
 * functionality.
 */
...
char * CKeywords[] = {"switch",  "if",     "while",   "for",       "break",   "continue", "return", "else",
                      "struct",  "union",  "typedef", "static",    "enum",    "case",     "int|",   "long|",
                      "double|", "float|", "char|",   "unsigned|", "signed|", "void|",    NULL};

char * CPPFileExtensions[] = {".cpp", ".hpp", ".cc", ".hh", NULL};

char * CPPKeywords[] = {"switch",
                        "if",
                        "while",
                        "for",
                        "break",
...
char * GoKeywords[] = {
    // Go keywords
    "if", "for", "range", "while", "defer", "switch", "case", "else", "func", "package", "import", "type", "struct",
    "import", "const", "var",
    // Go types
    "nil|", "true|", "false|", "error|", "err|", "int|", "int32|", "int64|", "uint|", "uint32|", "uint64|", "string|",
    "bool|", NULL};
...
char * JBASICKeywords[] = {
    // JBASIC keywords
    "LET", "DIM", "CLS", "INPUT", "PRINT", "NOT", "MOD", "IF", "THEN", "ELSE", "END", "FOR", "TO", "NEXT", "WHILE",
    "REPEAT", "UNTIL", "DO", "SWITCH", "CASE", "GOTO", "SUB", "CALL", "let", "dim", "cls", "input", "print", "not",
    "mod", "if", "then", "else", "end", "for", "to", "next", "while", "repeat", "until", "do", "switch", "case", "goto",
    "sub", "call",
    // JBASIC built in functions
    "ABS|", "ACS|", "ASH|", "ASN|", "ATH|", "ATN|", "AVG|", "COS|", "EXP|", "LOG|", "MAX|", "MIN|", "SIN|", "SQR|",
    "SUM|", "TAN|", "LIST|", "RND|", "VAL|", "LEN|", NULL};

char * LuaFileExtensions[] = {".lua", NULL};

char * LuaKeywords[] = {"and",      "break", "do",   "else",   "elseif", "end", "false", "for",
...
char * PythonKeywords[] = {
    ...
    // Python types
    "buffer|", "bytearray|", "complex|", "False|", "float|", "frozenset|", "int|", "list|", "long|", "None|", "set|",
    "str|", "tuple|", "True|", "type|", "unicode|", "xrange|", NULL};

editor_syntax_t HighLightDataBase[] = {
    {"C", CFileExtensions, CKeywords, "//", "/*", "*/", SYNTAX_HIGHLIGHT_NUMBERS | SYNTAX_HIGHLIGHT_STRINGS},
    ...
    {"JBASIC", JBASICFileExtensions, JBASICKeywords, "REM", "", "",
     SYNTAX_HIGHLIGHT_NUMBERS | SYNTAX_HIGHLIGHT_STRINGS},
    {"Lua", LuaFileExtensions, LuaKeywords, "--", "--[[", "--]]", SYNTAX_HIGHLIGHT_NUMBERS | SYNTAX_HIGHLIGHT_STRINGS},
    {"Python", PythonFileExtensions, PythonKeywords, "//", "", "", SYNTAX_HIGHLIGHT_NUMBERS | SYNTAX_HIGHLIGHT_STRINGS},
};
